...
function runGoldTierTest() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const priceData = yield MarketPriceService_1.MarketPriceService.getCropPrice('Sugarcane', SCENARIO.market);
        ...
        const waterCost = WaterCostCalculator_1.WaterCostCalculator.calculateWaterCost(SCENARIO.waterReq, 1, // 1 Acre 
        SCENARIO.pumpType, SCENARIO.waterDepth);
        ...
        const cropCat = YieldAdjustmentService_1.YieldAdjustmentService.getCropCategory(SCENARIO.cropId);
        const yieldAdj = YieldAdjustmentService_1.YieldAdjustmentService.adjustYieldForWaterStress(SCENARIO.baseYield, SCENARIO.waterReq, SCENARIO.waterAvailable, cropCat);
        ...
        const actualWaterCost = WaterCostCalculator_1.WaterCostCalculator.calculateWaterCost(SCENARIO.waterAvailable, 1, SCENARIO.pumpType, SCENARIO.waterDepth).totalCostSeason;
        ...
        const risk = CropRiskAssessment_1.CropRiskAssessment.assessRisk({
            id: SCENARIO.cropId,
