...
exports.CropRiskAssessment = void 0;
class CropRiskAssessment {
    /**
     * Assess Multi-Factor Risk for a Crop Plan
     */
    static assessRisk(crop, farmContext) {
        ...
        if (riskLevel === 'EXTREME')
            recs.push("NOT RECOMMENDED for planting", "Consider alternative crop");
        if (riskLevel === 'HIGH' || riskLevel === 'EXTREME')
            recs.push("Crop Insurance Mandatory", "Reduce planted area");
        if (farmContext.blockClassification === 'Over-exploited')
            recs.push("Adopt Drip Irrigation");
        if (farmContext.marketTrend === 'DOWN')
            recs.push("Secure contract selling if possible");
     ...
     */
    static calculateInsurancePremium(sumInsured, riskScore) {
...
exports.CropRiskAssessment = CropRiskAssessment;
