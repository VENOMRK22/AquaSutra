...
exports.WaterCostCalculator = void 0;
class WaterCostCalculator {
    /**
     * Calculate comprehensive cost of water extraction
     */
    static calculateWaterCost(waterRequirementMm, areaAcres, pumpType, waterTableDepthM, pumpConfig = { type: 'ELECTRIC', horsepower: 5, efficiency: 0.65, ageYears: 5 }) {
        ...
        if (safeEfficiency <= 0)
            safeEfficiency = 0.65; // Prevent division by zero
        // Step 1: Total Volume
     ...
     */
    static calculateTrueProfitIndex(crop, marketPricePerTon, waterTableDepthM, pumpType = 'ELECTRIC') {
     ...
     */
    static comparePumpTypes(waterRequirement, waterDepth, area) {
        return {
...
exports.WaterCostCalculator = WaterCostCalculator;
// Constants (Regional: UP/Maharashtra Blend)
WaterCostCalculator.ELECTRIC_RATE_PER_KWH = 7.5; // Commercial Agri Rate
WaterCostCalculator.DIESEL_RATE_PER_LITER = 95.0;
WaterCostCalculator.BOREWELL_ANNUAL_MAINTENANCE = 12000;
WaterCostCalculator.PUMP_COST_5HP = 45000;
WaterCostCalculator.PUMP_LIFE_YEARS = 10;
// Physics Constants
WaterCostCalculator.LITERS_PER_MM_ACRE = 4046.86; // 1 acre = 4046.86 sqm * 1mm (1L)
